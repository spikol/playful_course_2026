...
You read raw sensor data and guessed at cupboards.

**Both activities were transpositions**: research-level ideas, rebuilt into something you could argue about before coffee.

This hour names what you were doing.
...
## Sensor blind tasting — transposing "perception"

**Scholarly version:** signal processing, feature extraction, the symbol grounding problem.

**This morning's version:** a number on a screen, a guess about a cupboard.

The gap you felt — between *light level: 12* and *"it's in the dark cupboard"* — is the gap the whole field lives in.

**The honest move:** the activity lets you feel the gap instead of defining it.
...
You will apply this check to everything you build on Thursday.
...
- **This afternoon:** you build a paper classifier and watch it fail. Ask the three questions of it.
- **Tomorrow:** the same lens on generative AI — where the transposition problem gets harder.
- **Thursday:** you design your own activity. The transposition check is the design brief.
- **October:** you find out what your classroom did to your transposition.
